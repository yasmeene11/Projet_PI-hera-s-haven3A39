...
public class Animal {
    ...
    public Animal( String Animal_Name,String Animal_Breed,String Animal_Status,String Animal_Type,int Age,Date Enrollement_Date,String Animal_Image,String Animal_Description)
    {
    ...
    public Animal(int animalId, String Animal_Name, String Animal_Image) {
        this.animalId = animalId;
        this.Animal_Name = Animal_Name;
        this.Animal_Image = Animal_Image;
    }
    ...
    public Animal(int animalId, String Animal_Name,String Animal_Breed,String Animal_Status,int Age,String Animal_Image,String Animal_Description)
    {
        this.animalId=animalId;
        this.Animal_Name=Animal_Name;
        this.Animal_Breed=Animal_Breed;

...
public class GoogleCalendarIntegration {
    ...
    public static void addEvent() throws GeneralSecurityException, IOException {
        ...
        DateTime endDateTime = new DateTime(startDate.getTime() + 3600000); // Ajout de 1 jour pour exemple

        Event event = new Event()
                .setSummary("Paiement Donation UP")
                //.setLocation("Lieu à spécifier")
                .setDescription("Veuillez respecter le rendez-vous de paiement dans notre centre United Pets")
                .setStart(new EventDateTime().setDateTime(startDateTime).setTimeZone("Europe/Paris"))
                .setEnd(new EventDateTime().setDateTime(endDateTime).setTimeZone("Europe/Paris"));

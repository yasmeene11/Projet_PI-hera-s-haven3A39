    ...
    public class DisplayReportB {
        ...
        private void initialize() {
            try {
                // Create a ServiceRapport instance and use it throughout the initialize method
                ...
                // Initialize Quartz scheduler with the ServiceRapport instance
                ...
                jobDetail.getJobDataMap().put("serviceRapport", serviceRapport); // Use the same serviceRapport instance

                Trigger trigger = TriggerBuilder.newTrigger()
                        .withIdentity("reportGenerationTrigger", "group1")
                        .startNow()
                        .withSchedule(SimpleScheduleBuilder.simpleSchedule()
                                .withIntervalInSeconds(60) // Change this line
                                .repeatForever())
                        .build();

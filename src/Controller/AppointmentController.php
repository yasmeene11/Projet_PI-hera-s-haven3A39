    ...
    public function listAp(): Response
{
    ...
    public function ListApF(SessionInterface $session): Response
    {
    ...
    public function modifyApF(Request $request, AppointmentRepository $appointmentRepository, int $id,SessionInterface $session): Response
    {
        ...
        return $this->render('/Front/Appointment/modifyAP.html.twig', [
            'form' => $form->createView(),
            'id' => $appointment->getAppointmentId(),
            'user' => $user, // Correct method to get the appointment ID
        ]);
    }
